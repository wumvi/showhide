...
## Wumvi NoCommercial - Terms and conditions

1.  **Preamble:** This Agreement, signed on Dec 4, 2017 (hereinafter: Effective Date) governs the relationship between Kozlenko Vitaliy, a Business Entity, (hereinafter: Licensee) and wumvi, a private person whose principal place of business is {location} (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using NoCommercial (hereinafter: The Software) created and owned by Licensor, as detailed herein
